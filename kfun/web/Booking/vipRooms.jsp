...
<div class="hero-section">
    <h1 class="hero-title">VIP Room</h1>
    <p class="hero-subtitle">Sing like a superstar in our exclusive VIP rooms</p>
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <%
                ...
                if (selectedDate != null) {
                    ps = conn.prepareStatement(
                        "SELECT * FROM rooms WHERE type='VIP' AND availability = 1 AND date = ?"
                    );
                    ps.setDate(1, Date.valueOf(selectedDate));
                } else {
                    ps = conn.prepareStatement("SELECT * FROM rooms WHERE type='VIP' AND availability = 1");
                }
            ...
            <div class="alert alert-warning text-center">
                No VIP room available for the selected date.
            </div>
